...
namespace AI.Planner.Actions.Escape
{
    ...
    struct MoveDown : IJobParallelForDefer
    {
        ...
        void GenerateArgumentPermutations(StateData stateData, NativeList<ActionKey> argumentPermutations)
        {
            ...
            var FromFilter = new NativeArray<ComponentType>(2, Allocator.Temp){[0] = ComponentType.ReadWrite<AI.Planner.Domains.Waypoint>(), [1] = ComponentType.Exclude<AI.Planner.Domains.ActivationLock>(),  };
