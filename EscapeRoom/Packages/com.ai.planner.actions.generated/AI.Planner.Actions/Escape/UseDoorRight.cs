...
{
    [BurstCompile]
    struct UseDoorRight : IJobParallelForDefer
    {
        ...
        {
            var CharacterFilter = new NativeArray<ComponentType>(2, Allocator.Temp){[0] = ComponentType.ReadWrite<AI.Planner.Domains.Carrier>(),[1] = ComponentType.ReadWrite<AI.Planner.Domains.Character>(),  };
            var ToFilter = new NativeArray<ComponentType>(2, Allocator.Temp){[0] = ComponentType.ReadWrite<AI.Planner.Domains.KeyLock>(),[1] = ComponentType.ReadWrite<AI.Planner.Domains.Waypoint>(),  };
            ...
            for (int i2 = 0; i2 < FromObjectIndices.Length; i2++)
            {
                ...
                if (!(WaypointBuffer[ToObject.WaypointIndex].Left == stateData.GetTraitBasedObjectId(FromIndex)))
                    continue;
    ...
    public struct UseDoorRightFixupReference : IBufferElementData
    {
