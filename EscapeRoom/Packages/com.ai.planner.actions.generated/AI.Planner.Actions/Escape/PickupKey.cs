...
namespace AI.Planner.Actions.Escape
{
    ...
    struct PickupKey : IJobParallelForDefer
    {
        ...
        void GenerateArgumentPermutations(StateData stateData, NativeList<ActionKey> argumentPermutations)
        {
            ...
            var ItemFilter = new NativeArray<ComponentType>(3, Allocator.Temp){[0] = ComponentType.ReadWrite<AI.Planner.Domains.Carriable>(),[1] = ComponentType.ReadWrite<AI.Planner.Domains.Position>(),[2] = ComponentType.ReadWrite<AI.Planner.Domains.Item>(),  };
