...
namespace Generated.AI.Planner.Plans.Escape
{
    ...
    struct MoveUp : IJobParallelForDefer
    {
        ...
        [NativeDisableContainerSafetyRestriction] NativeList<MoveUpFixupReference> TransitionInfo;
        ...
        void InitializeLocalContainers()
        {
            ...
            TransitionInfo = new NativeList<MoveUpFixupReference>(ArgumentPermutations.Length, Allocator.Temp);
        }
        ...
        public void Execute(int jobIndex)
        {
            ...
            {
                TransitionInfo.Add(new MoveUpFixupReference { TransitionInfo = ApplyEffects(ArgumentPermutations[i], stateEntityKey) });
            }
