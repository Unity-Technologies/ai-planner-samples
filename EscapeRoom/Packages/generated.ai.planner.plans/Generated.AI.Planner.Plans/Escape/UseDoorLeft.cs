...
namespace Generated.AI.Planner.Plans.Escape
{
    ...
    struct UseDoorLeft : IJobParallelForDefer
    {
        ...
        [NativeDisableContainerSafetyRestriction] NativeList<UseDoorLeftFixupReference> TransitionInfo;
        ...
        void InitializeLocalContainers()
        {
            ...
            TransitionInfo = new NativeList<UseDoorLeftFixupReference>(ArgumentPermutations.Length, Allocator.Temp);
        }
        ...
        public void Execute(int jobIndex)
        {
            ...
            {
                TransitionInfo.Add(new UseDoorLeftFixupReference { TransitionInfo = ApplyEffects(ArgumentPermutations[i], stateEntityKey) });
            }
