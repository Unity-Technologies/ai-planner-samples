...
namespace Generated.AI.Planner.Plans.Escape
{
    ...
    struct MoveLeft : IJobParallelForDefer
    {
        ...
        [NativeDisableContainerSafetyRestriction] NativeList<MoveLeftFixupReference> TransitionInfo;
        ...
        void InitializeLocalContainers()
        {
            ...
            TransitionInfo = new NativeList<MoveLeftFixupReference>(ArgumentPermutations.Length, Allocator.Temp);
        }
        ...
        public void Execute(int jobIndex)
        {
            ...
            {
                TransitionInfo.Add(new MoveLeftFixupReference { TransitionInfo = ApplyEffects(ArgumentPermutations[i], stateEntityKey) });
            }
