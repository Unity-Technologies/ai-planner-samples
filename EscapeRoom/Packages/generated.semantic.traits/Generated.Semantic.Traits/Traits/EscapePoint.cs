...
namespace Generated.Semantic.Traits
{
    ...
    [AddComponentMenu("Semantic/Traits/EscapePoint (Trait)")]
    [RequireComponent(typeof(SemanticObject))]
    public partial class EscapePoint : MonoBehaviour, ITrait
    {
        ...
        public void Convert(Entity entity, EntityManager destinationManager, GameObjectConversionSystem _)
        {
            ...
            if (!destinationManager.HasComponent(entity, typeof(EscapePointData)))
            {
                destinationManager.AddComponent<EscapePointData>(entity);
            }
        }
        ...
        void OnDestroy()
        {
            ...
            {
                m_EntityManager.RemoveComponent<EscapePointData>(m_Entity);
        ...
        void OnDrawGizmos()
        {
            TraitGizmos.DrawGizmoForTrait(nameof(EscapePointData), gameObject,null);
        }
#endif
    }
}
