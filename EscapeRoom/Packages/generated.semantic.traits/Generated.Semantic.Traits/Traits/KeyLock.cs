...
namespace Generated.Semantic.Traits
{
    ...
    [AddComponentMenu("Semantic/Traits/KeyLock (Trait)")]
    [RequireComponent(typeof(SemanticObject))]
    public partial class KeyLock : MonoBehaviour, ITrait
    {
        ...
        public void Convert(Entity entity, EntityManager destinationManager, GameObjectConversionSystem _)
        {
            ...
            if (!destinationManager.HasComponent(entity, typeof(KeyLockData)))
            {
                destinationManager.AddComponent<KeyLockData>(entity);
            }
        }
        ...
        void OnDestroy()
        {
            ...
            {
                m_EntityManager.RemoveComponent<KeyLockData>(m_Entity);
        ...
        void OnDrawGizmos()
        {
            TraitGizmos.DrawGizmoForTrait(nameof(KeyLockData), gameObject,null);
        }
#endif
    }
}
