...
namespace Generated.AI.Planner.Plans.Match3Plan
{
    ...
    struct SwapRight : IJobParallelForDefer
    {
        ...
        [NativeDisableContainerSafetyRestriction] NativeList<SwapRightFixupReference> TransitionInfo;
        ...
        void InitializeLocalContainers()
        {
            ...
            TransitionInfo = new NativeList<SwapRightFixupReference>(ArgumentPermutations.Length, Allocator.Temp);
        }
        ...
        public void Execute(int jobIndex)
        {
            ...
            {
                TransitionInfo.Add(new SwapRightFixupReference { TransitionInfo = ApplyEffects(ArgumentPermutations[i], stateEntityKey) });
            }
